import * as wasm from './wasm_xena_lite_bg.wasm';
...
function __wbg_adapter_20(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h5936b393a5590405(arg0, arg1, addHeapObject(arg2));
}
...
function __wbg_adapter_51(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures__invoke0_mut__h50e4f9626559145c(arg0, arg1);
}
...
function __wbg_adapter_74(arg0, arg1, arg2, arg3, arg4) {
    wasm.wasm_bindgen__convert__closures__invoke3_mut__h44b872ba63f20078(arg0, arg1, addHeapObject(arg2), arg3, addHeapObject(arg4));
}

function __wbg_adapter_87(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h14165df31733bf64(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
export class XenaUi {
    ...
    static __wrap(ptr) {
        const obj = Object.create(XenaUi.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_xenaui_free(ptr);
    }
    /**
    * @returns {XenaUi}
    */
    static new() {
        const ret = wasm.xenaui_new();
        return XenaUi.__wrap(ret);
    }
    /**
    ...
    * @returns {string}
    */
    parse_cir(filedata, effort, strict) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(filedata, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.xenaui_parse_cir(retptr, this.ptr, ptr0, len0, effort, strict);
    ...
    * @returns {string}
    */
    read_cir(cir_name, dco_name, cir_dir, effort, strict) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(cir_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(dco_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(cir_dir, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len2 = WASM_VECTOR_LEN;
            wasm.xenaui_read_cir(retptr, this.ptr, ptr0, len0, ptr1, len1, ptr2, len2, effort, strict);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    save_nodes(nodes) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.xenaui_save_nodes(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    * @returns {string}
    */
    set_source(src_name, val) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(src_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.xenaui_set_source(retptr, this.ptr, ptr0, len0, val);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    set_tr_time(step, endtime) {
        wasm.xenaui_set_tr_time(this.ptr, step, endtime);
    }
    /**
    * @returns {string}
    */
    solve() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.xenaui_solve(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    step(tstep) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.xenaui_step(retptr, this.ptr, tstep);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    * @returns {string}
    */
    set_val(device_name, param_name, val) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            ...
            const len1 = WASM_VECTOR_LEN;
            wasm.xenaui_set_val(retptr, this.ptr, ptr0, len0, ptr1, len1, val);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    sweep(param_name, val) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passArray32ToWasm0(val, wasm.__wbindgen_malloc);
            const len1 = WASM_VECTOR_LEN;
            wasm.xenaui_sweep(retptr, this.ptr, ptr0, len0, ptr1, len1);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    * @returns {string}
    */
    add_device(device_name, model_name, geo_name, nodes) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(device_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            ...
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(geo_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len2 = WASM_VECTOR_LEN;
            const ptr3 = passArray32ToWasm0(nodes, wasm.__wbindgen_malloc);
            const len3 = WASM_VECTOR_LEN;
            wasm.xenaui_add_device(retptr, this.ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    * @returns {string}
    */
    add_model(model_name, model_data) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(model_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(model_data, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            wasm.xenaui_add_model(retptr, this.ptr, ptr0, len0, ptr1, len1);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    * @returns {string}
    */
    add_geometry(geo_name, geo_data) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(geo_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(geo_data, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            wasm.xenaui_add_geometry(retptr, this.ptr, ptr0, len0, ptr1, len1);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    width() {
        const ret = wasm.xenaui_width(this.ptr);
        return ret >>> 0;
    }
    /**
    * @returns {number}
    */
    height() {
        const ret = wasm.xenaui_height(this.ptr);
        return ret >>> 0;
    }
    /**
    * @returns {string}
    */
    render() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.xenaui_render(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
export function __wbg_wbgtestinvoke_1a19031fd0724979() { return handleError(function (arg0, arg1) {
    try {
        ...
        var cb0 = () => {
            ...
            state0.a = 0;
            try {
                return __wbg_adapter_51(a, state0.b, );
            } finally {
                state0.a = a;
            }
        };
...
export function __wbindgen_closure_wrapper2237(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 674, __wbg_adapter_20);
    return addHeapObject(ret);
};
